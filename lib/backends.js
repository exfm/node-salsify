...
SQS.prototype.put = function(queue, message, delaySeconds){
    delaySeconds = delaySeconds || 0;
    this.getQueue(queue).put(message, delaySeconds);
};
...
Memory.prototype.put = function(queue, message, delaySeconds){
    delaySeconds = delaySeconds || 0;
    var id = uuid.v4();
